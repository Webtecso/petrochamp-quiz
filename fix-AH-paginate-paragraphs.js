const content = `export function paginateText(text: string, maxChars: number): string[] {
...
`
require("fs").writeFileSync("src\\\\renderer\\\\src\\\\utils\\\\paginateText.ts", content, "utf8")
console.log("OK: paginateText.ts reescrito para respeitar paragrafos.")
